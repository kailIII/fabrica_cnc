	...
	<TABLE width="100%" border="0" cellspacing="0" cellpadding="0" align="left" style='border:1px solid #CED7EC;'>
	 <TR>
	  <TD align="center" colspan="2" valign="top">
		<div class="requi-item"><?php require_once dirname(__FILE__).'/brief1_calendario.php' ?></div>
		<div class="requi-item"><?php require_once dirname(__FILE__).'/brief1_metodologias.php' ?></div>
	 ...
	 <tr>
	 	<td colspan="4" >
	 		<div class="requi-mcambio-wrapper" >
	 			<textarea  id="motivo_cambio" name="motivo_cambio"  cols="30" rows="4"></textarea>
	 		</div>
	 	</td>
	 </tr>
	
	<td>
		<div style="text-align: center;" ><button class="btn btn-primary" type="submit" >Guardar</button></div>
	</td>
