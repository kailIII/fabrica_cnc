...
while($campos			= mysql_fetch_array($con)){
	...
	$new_id_row_metodologia = $campos["new_id_row_metodologia"];
...
//	if($idTipoMetodologia==3){
	if(!empty($idTipoMetodologia)){
		...
		while($camposR			= mysql_fetch_array($conR)){
			...
			$nameObjCant	= 'cantidad_met[' . $id_row_segmento . ']';
			...
			$filasInversion		.= "
			 <tr>
			  <td align='right' class='borderBR'><div class='padding5'>$contItems</td>
			  <td align='left' class='borderBR'><div class='padding5'>$nom_metodologia - $nom_segmento - <a class='requi-ver-metodologia' href ='met_iframe.php?idPropuesta=" . $idPropuesta . "&id_row_metodologia=" . $new_id_row_metodologia . "' >Ver metodología <i class=' icon-zoom-in' ></i> </a></div></td>
			  <td align='center' class='borderBR'><div class='padding5'>$objCantidad</div></td>
			  ...
			  <div class='padding5'>
				  ...
				  <select name='area_metodologia[" . $id_row_segmento . "]' >
					  " . $areas . "
				  </select>
	...
	if( $tabla != "2" ){
		...
		$filasInversion	.= " 
			<tr> 
				...
				<td align='right' class='borderBR'>
			  	<div class='padding5'>
				  <select name='area_inversion[" . $id_producto . "]' >
					  " . $areas . "
				  </select>
			  	</div>
			  	</td>
...
?>
	...
	<table id="tabla_inversion" width="60%" border="0" cellspacing="0" cellpadding="0" align="center" class="borderTL">
	 ...
	 <tr>
	  ...
	  <td width='5%' align='center' class='borderBR divInstruccion' nowrap="nowrap"><div class='padding5'><b>Área responsable</b></div></td>
	 </tr>
