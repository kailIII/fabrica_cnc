...
$limit_usuario = " AND elaborada_por = '{$Usuario->getIdEquipo()}'";
...
while($campos			= mysql_fetch_array($con)){
	...
	$linkEdit		= "<a href='./?idPropuesta=$id_propuesta' title='Editar propuesta'><IMG src='/imagenes/icoblg_fondo1.png' height='20' border='0'></a>";
	$linkTitulo		= "<a href='./?idPropuesta=$id_propuesta' title='Editar propuesta'><span class='linkF'><B>$titulo</B></span></a>";
	$linkObser 		= '<a class="linkF" href="prop_por_revisar.php?idPropuesta='. $id_propuesta .'" ><b>Ver</b></a>';
	...
	$filasPropuesta	.= "
	 <TR>
	  ...
	  <TD align='center' class='borderBR'><div class='padding5'>$linkObser</div></TD>
  ...
  <TD>
    <TABLE cellSpacing='0' cellPadding='0' width='100%' align='center' border='0' class="borderTL">
     <TR style="background-color:#CCC">
      ...
      <td align="left" class="borderBR" ><div class="padding5"><b>Observaciones</b></div></td>
