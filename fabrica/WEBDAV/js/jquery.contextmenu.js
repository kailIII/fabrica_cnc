...
;(function($){
	$.contextMenu = {
		...
		createMenuItem: function(label,obj) {
			...
			var $div = $('<div class="'+cmenu.itemClassName+' '+o.className+((o.disabled)?' '+cmenu.disabledItemClassName:'')+'" title="'+o.title+'" id="'+o.id+'"></div>')
	...
	$.fn.contextMenu = function(menu,options) {
		...
		return this.each(function(){			
			if(cmenu.showOn=='both' || cmenu.showOn=='left')
				$(this).bind('click',function(e){cmenu.show(this,e);return false;});
			if(cmenu.showOn=='both' || cmenu.showOn=='right' || cmenu.showOn == null || cmenu.showOn == undefined);
