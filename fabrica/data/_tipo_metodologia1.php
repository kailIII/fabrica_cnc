...
//	$linkSegmento		= "<a href=\"javascript:document.getElementById('idRowSegmento').value=$id_row_segmento;\" class='contact'><span style='color:#036'>$nom_segmento</span></a>";
	...
	$filasSegmentos	.= "
	 <TR>
	  ...
	  <TD align='left' class='borderBR'><div class='padding5'>$lugar</div></TD>
	 </TR>";
}
?>
    ...
    <TABLE width="98%" border="0" cellspacing="0" cellpadding="0" align="center" style="padding-bottom:10px;">
	 ...
	 <TR>
	  <TD align='left' colspan="2">
        <div align="left" class='padding5 textLabel'><B>Definici&oacute;n de segmentos o ciudades:</B></div>
        <TABLE cellSpacing='0' cellPadding='0' width='100%' align='center' border='0' class="borderTL">
         <TR style="background-color:#CCC">
          <TD width='1%' align='left' class='bb'>&nbsp;</TD>
          <TD align='left' class='borderBR'><div class='padding5'><B>Segmento o ciudad</B></div></TD>
          <TD width='15%' align='left' class='borderBR'><div class='padding5'><B>Muestra o sesiones</B></div></TD>
          <TD width='30%' align='left' class='borderBR'><div class='padding5'><B>Lugar</B></div></TD>
         </TR>
         <?=$filasSegmentos?>
        </TABLE>
      </TD>
