...
$funcion_save	= "save_tipo_metodologia3('$idRowMetodologia','$idPropuesta','$idObjTitulo','$idObjTemas','$idObjUniverso','$idObjMarco','$idDivS');";
  ...
  <TD align='left' colspan="3">
    <TABLE width="98%" border="0" cellspacing="0" cellpadding="0" align="center" style="padding-bottom:10px;">
     ...
     <TR>
      ...
      <TD align='left' class="bb"><div class='padding5'>El univeso es una descripci&oacute;n del conjunto de las unidades o individuos que satisfacen una definici&oacute;n com&uacute;n y constituyen la colectividad de inter&eacute;s. El Universo debe ser reflejo de los objetivos del estudio, por lo tanto debe describirse en t&eacute;rminos de contenido, unidades, espacio y tiempo)<br />
      <INPUT type="text" name="<?=$idObjUniverso?>" id="<?=$idObjUniverso?>" value="<?=$vr_universo?>" class="txt" style="width:800px;" onchange="<?=$funcion_save?>" /></div></TD>
     </TR>
     <TR>
      <TD align='left' class="bb" nowrap="nowrap"><div class='padding5 textLabel'>Marco estad&iacute;stico :</div></TD>
      <TD align='left' class="bb"><div class='padding5'>Es el archivo alfanum&eacute;rico o el mecanismo geogr&aacute;fico que permite identificar y ubicar &ndash;con los que se contactan- a los elementos del universo. Nota: Censo es cuando el marco estad&iacute;stico es igual al universo.<br />
      <INPUT type="text" name="<?=$idObjMarco?>" id="<?=$idObjMarco?>" value="<?=$vr_marco_estadistico?>" class="txt" style="width:800px;" onchange="<?=$funcion_save?>" /></div></TD>
     </TR>
     <TR>
