...
?>
   ...
   <TABLE width="100%" cellspacing="0" cellpadding="2" align='center' border="0" style="background-color:#333333" id="navBarMain" >
	 ...
	 <TR>
	  ...
	  <TD width="10%" align='center' valign='middle' nowrap="nowrap" style=" <?=$rowAtrib[1]?>"<?=$rowBg[1]?>><div class="padding5"><a href="/propuesta/fabrica_dev/?idMenu=1"><span style='color:#FFFFFF;'>Nueva</span></a></div></TD>

	  <TD width="1%" align='center' valign='middle'><div style='color:#FFFFFF;'>|</div></TD>

	  <TD width="10%" align='center' valign='middle' nowrap="nowrap" style=" <?=$rowAtrib[2]?>"<?=$rowBg[2]?>><div class="padding5"><a href="/propuesta/fabrica_dev/lista_propuestas.php?idMenu=2"><span style='color:#FFFFFF;'>Propuestas realizadas</span></a></div></TD>
      
       
	  <TD width="1%" align='center' valign='middle'><div style='color:#FFFFFF;'>|</div></TD>
		<TD width="10%" align='center' valign='middle' nowrap="nowrap" style=" <?=$rowAtrib[3]?>" ><div class="padding5"><a href="/propuesta/fabrica_dev/propuestas_por_revisar.php?idMenu=3"><span style='color:#FFFFFF;'>Propuestas por revisar</span></a></div></TD>
	  <TD width="1%" align='center' valign='middle'><div style='color:#FFFFFF;'>|</div></TD>
